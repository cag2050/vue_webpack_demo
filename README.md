...
运行：npm run dev，访问[http://localhost:8888/app/[xxx]/index.html](http://localhost:8888/app/index/index.html)  ， 修改html模板、vue组件、model-view的js、css文件，都可自动刷新。  

运行：npm run build,构建可以发布到服务器的正式文件。 直接访问html文件，比如[http://localhost:63342/vue_demo/output/[xxx]/index.html](http://localhost:63342/vue_demo/output/index/index.html)
